...
export const AlbumSinglesForPringles: React.FC<SongsProps> = ({
  onTrackSelected,
  view,
}) => {
    ...
    const fetchTracksAndAlbumInfo = async () => {
      ...
      if (accessToken) {
        ...
        const [albumDetails, trackList] = await Promise.all([
          getAlbumDetails("36IkSOdQIhxbyEknf6Dpk1", accessToken),
          getAlbumTracks("36IkSOdQIhxbyEknf6Dpk1", accessToken),
        ]);
